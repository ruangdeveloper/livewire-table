    ...
    <div class="relative overflow-x-auto">
        <table class="w-full text-sm text-left text-gray-500">
            <thead class="text-xs text-gray-700 bg-gray-100">
                <tr>
                    @if ($LTwithBulkAction)
                        <th class="px-6 py-3 border" style="cursor: pointer; width:40px;" title="Select all"
                            scope="col">
                        ...
                        @else
                            @if ($LTcolumn->isSortable())
                                ...
                                <th id="{{ $LTcolumn->getName() . '__' . $LTcolumnIndex }}"
                                    class="px-6 py-3 border whitespace-nowrap" scope="col">
                ...
                @if ($LTwithPagination && $LTdata->hasPages())
                    <div>
                        <select wire:model.live="LTperPage"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-2">
